...
fallback 23 + quiet prompt; facts on `profiles` (migration `20260919100000`, **applied + verified on production 2026-09-19**). Fixed: keyboard pre-focus jump for visible controls; quantity edit leaking fields across
