...
## DEC-024 — ניווט יומי, בטיחות מקלדת ומודל צעדים
...
הניווט התחתון מכיל רק בית, הוספה מהירה ויומן. אזור ההקשר היומי הוא רשת מאוזנת של שקילה, אימון, צום וצעדים. כל עורך קלט משתמש בגובה ה־Visual Viewport, גוף גליל ו־safe area כדי לשמור את הקלט והפעולה הראשית מעל המקלדת.

יעד הצעדים נשמר כהגדרה אחת לכל Profile עם fallback ראשון של 10,000. דיווח יומי נשמר בישות נפרדת לפי `(profile_id, log_date)`, עם מספר אופציונלי, סימון ביצוע ו-snapshot של היעד באותו יום. צעדים אינם משפיעים על שלמות שש הארוחות.

### השלכות

- נדרשת migration קדימה בלבד לשתי טבלאות עם RLS של חברות Household ו-Realtime.
- דיווחים ויעדים מבודדים לפי Profile ותומכים בתאריך הנבחר, Offline Queue ו-Reconnect.
- אין יעדי כושר, ניקוד או Gamification מעבר ליעד הצעדים שהמשתמש עורך.
