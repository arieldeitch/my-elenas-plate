...
export type FoodInsert = T["foods"]["Insert"];
export type FoodReferenceItemRow = T["food_reference_items"]["Row"];
export type DishRow = T["dishes"]["Row"];
export type DishInsert = T["dishes"]["Insert"];
export type DishVersionRow = T["dish_versions"]["Row"];
export type DishVersionInsert = T["dish_versions"]["Insert"];
export type EstimatedProductRow = T["estimated_products"]["Row"];
export type EstimatedProductInsert = T["estimated_products"]["Insert"];
export type WeightBridgeRow = T["weight_bridges"]["Row"];
export type WeightBridgeInsert = T["weight_bridges"]["Insert"];
export type FoodReferenceAliasRow = T["food_reference_aliases"]["Row"];
export type FoodPreferenceRow = T["food_preferences"]["Row"];
export type FoodPreferenceInsert = T["food_preferences"]["Insert"];
