...
export function FastingEditor({ onDone }: Props) {
  ...
  return (
    <div className="keyboard-safe-scroll max-h-[calc(var(--app-viewport-height)-12rem)] space-y-3 overflow-y-auto pb-[max(0.5rem,env(safe-area-inset-bottom))]" data-testid="fasting-editor">
