  ...
  return (
    ...
    >
      <div
        ...
        aria-hidden
      />
      <div className="keyboard-safe-sheet relative flex w-full max-w-md flex-col overflow-hidden rounded-t-3xl bg-card border border-border shadow-lg sm:rounded-3xl animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-200">
        ...
        <div className="keyboard-safe-scroll flex-1 overflow-y-auto p-4 space-y-3">
        ...
        <div className="shrink-0 border-t border-border bg-card p-3 flex gap-2 pb-[calc(env(safe-area-inset-bottom)+12px)]">
          <button
            onClick={submit}
